...
RSpec.configure do |config|
  ...
  # plugin_install runs the plugin's on_active hook on the caller (hook_run extends it with the plugin's
  # helpers), and that hook names its settings with `t`, so give the examples the controller's
  # translation method.
